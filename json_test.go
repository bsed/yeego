...
func TestJson_GetPath(t *testing.T) {
	json := Init(`{"projects":{"id":302,"name":"测试0109","startTime":1483957800000,"endTime":1485426600000,"tag":"做市","type":"企"}}`)
	NotEqual(json.GetPath("projects", "id").Data, nil)
}

func TestJson_ArrayIndex(t *testing.T) {
	json := Init(`["data1","data2"]`)
